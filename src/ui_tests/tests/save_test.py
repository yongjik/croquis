...
def test_kernel_restart(launcher, context):
    ...
    test_helper.check_center_label(page, cell1, 'center1')
    ...
    test_helper.check_center_label(page, cell3, 'center3', timeout=10000)
...
def test_save_load(launcher, context):
    ...
    test_helper.check_center_label(page2, cell3, 'center3')

    # Check that we can re-run cell 2.
    cell2, axis2 = test_helper.run_jupyter_cell(page2, 'CELL2', 'div.cr_x_axis')
    test_helper.check_center_label(page2, cell2, 'center2')
