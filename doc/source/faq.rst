...
+---------------+--------+----------------------------------------------+--------------+
| Library       | batch? | time to draw [2]_                            | interactive? |
|               | [1]_   +----------------------------------------------+              |
|               |        | # lines (# points)                           |              |
|               |        +-----------+-----------+-----------+----------+              |
...
|               +--------+-----------+-----------+-----------+----------+              |
|               | No     | 0.33s     | 0.58s     | 1.2s      | 11s      |              |
+---------------+--------+-----------+-----------+-----------+----------+--------------+
| `bokeh`_      | Yes    | 2.4s      | 11s       | 21s       |          | ✅           |
+---------------+--------+-----------+-----------+-----------+----------+--------------+
| `plotly`_     | (N/A)  | 15s       | 81s       | (fails)   |          | ✅           |
+---------------+--------+-----------+-----------+-----------+----------+--------------+
| `matplotlib`_ | (N/A)  | 1.2s      | 5.5s      | 11s       | 100+s    | ❌           |
+---------------+--------+-----------+-----------+-----------+----------+--------------+
...
.. [1] Uses a batch API to add all lines at once (vs. adding lines one by one in
       ...
       croquis.  It seems like batch API isn't available for plotly and
       matplotlib.
